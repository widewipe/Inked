...
export const Item = ({
  ...
  const onArchive = (e: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    toast.promise(promise, {
      ...
      success: "Successfully deleted the note!",
  ...
  const onCreate = (e: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    toast.promise(promise, {
      ...
      success: "Successfully create a note!",
        ...
        <div className=" ml-auto flex items-center gap-x-2">
          <DropdownMenu>
            <DropdownMenuTrigger onClick={(e) => e.stopPropagation()} asChild>
              <div
                role="button"
                className="opacity-0 group-hover:opacity-100 rounded-sm h-full ml-auto p-1 hover:bg-neutral-300 dark:hover:bg-neutral-600"
              >
          ...
          <div
            role="button"
            onClick={onCreate}
            className="opacity-0 group-hover:opacity-100 h-full ml-auto p-1 rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600"
          >
